...
class MyStatelessWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    return new Scaffold(
      appBar: new AppBar(title: new Text("panama")),
      body: new Container(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new MyCard(
               title: new Text("I Love donuter", style: new TextStyle(fontSize: 25.0),),
               icon: new Icon(Icons.donut_large,size: 40.0,color: Colors.brown,),
            ),
            new MyCard(
               title: new Text("I see You!", style: new TextStyle(fontSize: 25.0),),
